...
public class ProductDaoTest extends BaseTest {
	...
	public void testAInsertProduct() throws Exception {
		...
		product1.setProductDescription("测试Desc1");
		...
		product2.setProductDescription("测试Desc2");
		...
		product3.setProductDescription("测试Desc3");
	...
	// .queryProductList(productCondition, 0, 3);
	...
	// productCondition.setCategory(pc);
