...
import com.chaucer.o2o.dao.LocalAuthDao;
import com.chaucer.o2o.dto.LocalAuthExecution;
import com.chaucer.o2o.entity.LocalAuth;
import com.chaucer.o2o.enums.LocalAuthStateEnum;
import com.chaucer.o2o.exceptions.LocalAuthOperationException;
import com.chaucer.o2o.service.LocalAuthService;
import com.chaucer.o2o.util.MD5;
...
public class LocalAuthServiceImpl implements LocalAuthService {
	...
	public LocalAuthExecution bindLocalAuth(LocalAuth localAuth)
		...
		if (localAuth == null || localAuth.getPassword() == null
				...
				|| localAuth.getUser() == null
				|| localAuth.getUser().getUserId() == null) {
			return new LocalAuthExecution(LocalAuthStateEnum.NULL_AUTH_INFO);
		}
		// 查询此用户是否已绑定过平台帐号
		LocalAuth tempAuth = localAuthDao
				.queryLocalByUserId(localAuth.getUser().getUserId());
		if (tempAuth != null) {
		...
		try {
			...
			throw new LocalAuthOperationException(
					"insertLocalAuth error: " + e.getMessage());
		}
	}
